...
void check_same_device(const torch::Tensor& x, const torch::Tensor& reference, const char* name) {
    TORCH_CHECK(x.device() == reference.device(), name, " must be on the same CUDA device as x");
}
...
void check_common_inputs(
    ...
    check_same_device(r, x, "r");
    check_same_device(k, x, "k");
    check_same_device(v, x, "v");
    check_same_device(r_k, x, "r_k");
    check_same_device(weight, x, "weight");
    check_same_device(bias, x, "bias");
    check_same_device(g, x, "g");
...
std::vector<torch::Tensor> backward(
    ...
    check_same_device(grad_xg, x, "grad_xg");
    check_same_device(mean, x, "mean");
    check_same_device(rstd, x, "rstd");
