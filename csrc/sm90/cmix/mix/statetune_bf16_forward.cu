...
// Local adaptation: use a nonzero initial shift and return the final input.
...
__global__ void statetune_cmix_mix_forward_kernel(
...
std::vector<torch::Tensor> statetune_cmix_forward_cuda(
  ...
  statetune_cmix_mix_forward_kernel<<<
