...
std::vector<torch::Tensor> pretrain_tmix_lnx_rkvres_xg_cuda(
    torch::Tensor x,
    torch::Tensor r,
    torch::Tensor k,
    torch::Tensor v,
...
std::vector<torch::Tensor> pretrain_tmix_lnx_rkvres_xg_forward(
    torch::Tensor x,
    torch::Tensor r,
    torch::Tensor k,
    torch::Tensor v,
...
void register_pretrain_tmix_lnx_rkvres_xg_forward_bindings(py::module_& module) {
  module.def(
      "pretrain_tmix_lnx_rkvres_xg_forward",
      &pretrain_tmix_lnx_rkvres_xg_forward,
