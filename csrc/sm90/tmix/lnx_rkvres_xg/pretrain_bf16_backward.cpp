...
std::vector<torch::Tensor> pretrain_tmix_lnx_rkvres_xg_backward_cuda(
...
std::vector<torch::Tensor> pretrain_tmix_lnx_rkvres_xg_backward(
    torch::Tensor grad_output,
    torch::Tensor x,
    torch::Tensor r,
    torch::Tensor k,
...
void register_pretrain_tmix_lnx_rkvres_xg_backward_bindings(py::module_& module) {
  module.def(
      "pretrain_tmix_lnx_rkvres_xg_backward",
      &pretrain_tmix_lnx_rkvres_xg_backward,
