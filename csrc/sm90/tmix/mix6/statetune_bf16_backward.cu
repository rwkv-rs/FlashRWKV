...
// Canonical source: RWKV-LM RWKV-v7/train_temp/cuda/rwkv7_tmix_mix6_bf16_v5.cu
...
__global__ void statetune_tmix_mix6_backward_kernel(
...
std::vector<torch::Tensor> statetune_tmix_mix6_backward_cuda(
  ...
  statetune_tmix_mix6_backward_kernel<<<blocks, threads, 0, stream>>>(
