...
std::vector<torch::Tensor> pretrain_tmix_mix6_forward_cuda(
...
std::vector<torch::Tensor> pretrain_tmix_mix6_forward(
  ...
  return pretrain_tmix_mix6_forward_cuda(x, x_r, x_w, x_k, x_v, x_a, x_g);
}

void register_pretrain_tmix_mix6_forward_bindings(py::module_& module) {
  module.def("pretrain_tmix_mix6_forward", &pretrain_tmix_mix6_forward,
