...
NATIVE_SOURCE_PATHS = (
    ...
    Path("csrc/infer/recurrent/infer_common_recurrent_varlen_bindings.cpp"),
    Path("csrc/infer/recurrent/infer_common_recurrent_fp32io16_forward_varlen.cu"),
    Path("csrc/infer/recurrent/infer_sm80_recurrent_fp16_forward_varlen.cu"),
