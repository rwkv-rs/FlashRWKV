...
def main() -> None:
    ...
    for _ in range(10):
        infer_head_linear_forward_varlen(x, weight)
    ...
    result = {"operator": "infer_head_linear_forward_varlen", "raw_latency_us": samples, "p50_us": sorted(samples)[len(samples) // 2], "source_revision": "ee3308f6922e59f2166c7fac3c5a192340a2b48e", "gpu": torch.cuda.get_device_name(), "correctness": "validated-by-tests/head/linear/test.py"}
