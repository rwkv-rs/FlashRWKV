...
MINIMUM_WHEEL_ARCHITECTURE = "sm60"
COMPILE_ONLY_ARCHITECTURES = ("sm90", "sm120")
RUNTIME_VALIDATED_ARCHITECTURES = ("sm61", "sm120")
BUILD_TARGET_MATRIX = (
...
TRANSLATION_UNIT_ARCHITECTURES = {
    ...
    "csrc/infer/wkv7/infer_common_fused_fp16_forward.cu": "common",
    "csrc/infer/wkv7/infer_common_recurrent_fp32io16_forward_varlen.cu": "common",
    "csrc/infer/wkv7/infer_sm80_recurrent_fp16_forward_varlen.cu": "common",
    ...
    "csrc/pretrain/wkv7/pretrain_sm90_cmix_bf16_forward_backward.cu": "common",
    "csrc/pretrain/wkv7/pretrain_sm90_tmix_kk_pre_bf16_forward_backward.cu": "common",
    "csrc/pretrain/wkv7/pretrain_sm90_tmix_mix6_bf16_forward_backward.cu": "common",
...
def validate_wheel_architectures(
    ...
    *,
    ...
    """Reject full-extension builds below the Pascal package minimum."""
    ...
    if requested is not None:
        ...
        raise ValueError(
            ...
            ">= 6.0 (SM60 minimum) when no CUDA device is available"
        )
    unsupported = tuple(capability for capability in capabilities if capability < (6, 0))
    if unsupported:
        ...
        raise RuntimeError(
            ...
            f">= 6.0 because its kernels require native FP16 arithmetic; "
