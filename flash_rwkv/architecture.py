...
TRANSLATION_UNIT_ARCHITECTURES = {
    ...
    "csrc/infer/fused/infer_common_fused_fp16_forward.cu": "common",
    "csrc/infer/recurrent/infer_common_recurrent_fp32io16_forward_varlen.cu": "common",
    "csrc/infer/recurrent/infer_sm80_recurrent_fp16_forward_varlen.cu": "sm80",
