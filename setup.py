    ...
    ext_modules=[
        CUDAExtension(
            ...
            sources=[
                ...
                "csrc/pretrain/wkv7/pretrain_smxx_tmix_a_gate_bf16_forward_backward_registration.cpp",
                "csrc/pretrain/wkv7/pretrain_smxx_tmix_a_gate_bf16_forward_backward.cu",
                "csrc/pretrain/wkv7/pretrain_smxx_tmix_kk_pre_bf16_forward_backward_registration.cpp",
                "csrc/pretrain/wkv7/pretrain_smxx_tmix_kk_pre_bf16_forward_backward.cu",
                "csrc/pretrain/wkv7/pretrain_smxx_tmix_lnx_rkvres_xg_bf16_forward_backward_registration.cpp",
                "csrc/pretrain/wkv7/pretrain_smxx_tmix_lnx_rkvres_xg_bf16_forward_backward.cu",
                "csrc/pretrain/wkv7/pretrain_smxx_tmix_mix6_bf16_forward_backward_registration.cpp",
                "csrc/pretrain/wkv7/pretrain_smxx_tmix_mix6_bf16_forward_backward.cu",
                "csrc/pretrain/wkv7/pretrain_smxx_tmix_vres_gate_bf16_forward_backward_registration.cpp",
